...
## Project Structure
    ...
    ├── falling_wildflower_41101  # Django project configurations
...
1. Clone this repo and `cd falling_wildflower_41101`
...
2. Clone this repo and `cd falling_wildflower_41101`
